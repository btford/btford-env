...
(defun js2r--setup-wrapping-pair (open close)
  (define-key js2-mode-map (read-kbd-macro open)
    (lambda () (interactive) (js2r--self-insert-wrapping open close)))
  (unless (s-equals? open close)
    (define-key js2-mode-map (read-kbd-macro close)
      '(lambda () (interactive) (js2r--self-insert-closing open close)))))
